    ...
    <div class="icon-section skin-blue">
        <div class="container">
            <ul class="list-inline">
                <li>
                    <a href="<?php echo \App\ViewInfo::first()->instagram; ?>"> <i class="livicon" data-name="instagram" data-size="18" data-loop="true" data-c="#fff"
                                    data-hc="#757b87"></i>
                    </a>
                </li>
            ...
            <ul class="list-unstyled">
                <li style="margin-bottom: 10px">
                    <i class="livicon icon4 icon3" data-name="cellphone" data-size="18" data-loop="true" data-c="#ccc"
                       data-hc="#ccc"></i>WICKR:<?php echo \App\ViewInfo::first()->phone; ?>

                </li>
                <li style="margin-bottom: 10px">
                    <i class="livicon icon4 icon3" data-name="cellphone" data-size="18" data-loop="true" data-c="#ccc"
                       data-hc="#ccc"></i> THREEMA:<?php echo \App\ViewInfo::first()->fax; ?>
