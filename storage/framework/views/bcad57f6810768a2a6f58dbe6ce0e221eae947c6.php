                            ...
                            <form method="post" action="<?php echo route('admin.viewinfo.save'); ?>"
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input required type='file' name="photos[]" id="upload_temp" multiple>
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="about_us" name="about_us"
                                                      class="form-control resize_vertical" rows="16"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input required class="form-control" type="text" name="address"
                                                   placeholder="Address"
                                                   is="address" value="<?php echo $viewinfo->address; ?>">
                                            <?php echo $errors->first('address', '<span class="help-block" style="color:red !important">:message</span>'); ?>

                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Phone</label>
                                            <input required class="form-control" type="text" id="mask_phone"
                                                   name="phone"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input required class="form-control" type="text" id="mask_fax" name="fax"
                                                   placeholder="Fax"
