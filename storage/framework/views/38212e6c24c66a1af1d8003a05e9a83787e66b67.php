                        ...
                        <table class="table table-striped table-bordered table-advance table-hover">
                            ...
                            <?php $__currentLoopData = $product_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr id="everyproduct<?php echo $product->id; ?>" class="detail_product"
                                    ...
                                    <td>
                                        <div class="row">
                                            <a class="btn default btn-xs mb-2" style="display: inline-block !important;" href="<?php echo route('admin.editimage', $product->id); ?>">
                                                &nbsp;&nbsp;&nbsp;<i class="livicon" data-name="edit" data-loop="true" data-color="#000"
                                                   data-hovercolor="black" data-size="14"></i>Edit  Photo&nbsp;&nbsp;
                                            </a>
                                        </div>
                                        <div class="row">
                                            <a class="btn default btn-xs mb-2" style="display: inline-block !important;" href="<?php echo route('admin.editprice', $product->id); ?>">
                                                &nbsp;&nbsp;&nbsp;<i class="livicon" data-name="edit" data-loop="true" data-color="#000"
                                        ...
                                        <div class="row">
                                            <button class="del_product btn default btn-xs purple"
                                                ...
                                                Del Product<input type="hidden" id="productid<?php echo $product->id; ?>"
