                ...
                <div class="portlet-body">
                        ...
                        <div class="col-md-3">
                            <form id="sort_form" method="get">
                                ...
                                <select class="form-control" id="show_status">
                                    ...
                                    <option value="5" <?php if($id == 5): ?> selected <?php endif; ?>>Particial Payed</option>
                                </select>
                            </form>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="table-scrollable">
                        <table class="table table-striped table-bordered table-advance table-hover">
                            ...
                            <tbody>
                            <?php $i = 0 + ($transactions->currentPage() - 1) * 10 ;?>
                                ...
                                <tr id="everytransaction<?php echo $transaction->id; ?>" class="detail_transaction"
                                    ...
                                    <td>
                                        <?php switch($transaction->pay_status):
                                            ...
                                            <?php case (5): ?>  <span class="label label-warning">Particial Payed</span> <?php break; ?>
                                        <?php endswitch; ?>
                                    </td>
                                    <td>
                                        <?php echo $transaction->created_at->format('Y-m-d H:i'); ?>
